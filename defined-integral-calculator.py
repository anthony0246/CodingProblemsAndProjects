...
#take in all necessary information in order to calculate the defined integral (the function itself and the location of the bornes)
...
#insure that the value given for the number_of_sub_intervals is valid
number_of_sub_intervals = int(input(f"Please input the number of sub intervals for the defined integral. Note: This value must be an even integer for Simpson's method: "))
while (int(number_of_sub_intervals) % 2) != 0 and int(number_of_sub_intervals) != 0:
    number_of_sub_intervals = int(input(f"Please input the number of sub intervals for the defined integral. Note: This value must be a positive and even integer for Simpson's method: "))

def apply_simpsons_rule(function_to_integrate, top_borne, bottom_borne, number_of_sub_intervals): #applying Simpson's rule to calculate the defined integral
...
print(apply_simpsons_rule(function_to_integrate, top_borne, bottom_borne, number_of_sub_intervals))